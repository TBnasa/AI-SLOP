      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          <div className="border-[5px] border-black bg-white w-full lg:w-[600px] brutal-shadow-lg">
            <div className="border-b-[3px] border-black px-4 py-2 bg-[#ff6600] text-white font-mono text-[10px] uppercase">
              COUNTER.EXE
            </div>
            <div className="p-6">
              <h2 className="brutal-heading text-4xl mb-6">{t("counter.title")}</h2>
              <input type="text" value={input} onChange={(e) => setInput(e.target.value)} className="brutal-input w-full text-sm mb-4" placeholder={t("counter.placeholder")} />
              ...
              <button onClick={handleCount} className="brutal-btn brutal-btn-orange w-full">{t("counter.button")}</button>
            </div>
          </div>
