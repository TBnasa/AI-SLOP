        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          <div className="border-[5px] border-black bg-white w-full lg:w-[600px] brutal-shadow-lg">
            ...
            <div className="p-6 text-center">
              ...
              <div className="border-[5px] border-black p-10 mb-6 bg-gray-100 font-display text-7xl">{time || "00:00:00"}</div>
              <button onClick={handleQuery} className="brutal-btn brutal-btn-blue w-full">{t("relativity.button")}</button>
            </div>
          </div>
